...
void MvdCollectionModel_P::sort(Movida::MovieAttribute attribute, Qt::SortOrder order)
{
        ...
        for (int i = 0; i < movies.size(); ++i)
        {
                ...
                case Movida::SeenAttribute: w.data = QVariant(movie.hasSpecialTagEnabled(Movida::SeenTag)); l << w; break;
                case Movida::SpecialAttribute: w.data = QVariant(movie.hasSpecialTagEnabled(Movida::SpecialTag)); l << w; break;
                case Movida::LoanedAttribute: w.data = QVariant(movie.hasSpecialTagEnabled(Movida::LoanedTag)); l << w; break;
                default: ;
                }
        }
