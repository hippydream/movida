...
//! \internal
MvdZip::ErrorCode MvdZip::Private::createArchive(QIODevice *dev)
{
    Q_ASSERT(dev != 0);
...
MvdZip::ErrorCode MvdZip::Private::createEntry(const QFileInfo &file, const QString &root,
    MvdZip::CompressionLevel level)
{
...
//! \internal
int MvdZip::Private::decryptByte(quint32 key2) const
{
...
void MvdZip::Private::setULong(quint32 v, char *buffer, unsigned int offset)
{
...
void MvdZip::Private::initKeys(quint32 *keys) const
{
...
void MvdZip::Private::updateKeys(quint32 *keys, int c) const
{
...
void MvdZip::Private::encryptBytes(quint32 *keys, char *buffer, qint64 read)
{
    char t;
...
MvdZip::CompressionLevel MvdZip::Private::detectCompressionByMime(const QString &ext)
{
...
*/
MvdZip::ErrorCode MvdZip::Private::closeArchive()
{
    ...
    for (QMap<QString, MvdZipEntry *>::ConstIterator itr = headers->constBegin(); itr != headers->constEnd(); ++itr) {
        h = itr.value();
...
/*!
    ...
    "/home".
*/
QString MvdZip::Private::extractRoot(const QString &p, MvdZip::CompressionOptions o)
{
    Q_UNUSED(o);
...
QString MvdZip::formatError(MvdZip::ErrorCode c) const
{
    switch (c) {
        case NoError:
            return QCoreApplication::translate("MvdZip", "ZIP operation completed successfully."); break;

        case ZlibInitError:
            return QCoreApplication::translate("MvdZip", "Failed to initialize or load zlib library."); break;

        case ZlibError:
            return QCoreApplication::translate("MvdZip", "zlib library error."); break;

        case FileOpenError:
            return QCoreApplication::translate("MvdZip", "Unable to create or open file."); break;

        case NoOpenArchiveError:
            return QCoreApplication::translate("MvdZip", "No archive has been created yet."); break;

        case FileNotFoundError:
            return QCoreApplication::translate("MvdZip", "File or directory does not exist."); break;

        case ReadError:
            return QCoreApplication::translate("MvdZip", "File read error."); break;

        case WriteError:
            return QCoreApplication::translate("MvdZip", "File write error."); break;

        case SeekError:
            return QCoreApplication::translate("MvdZip", "File seek error."); break;
