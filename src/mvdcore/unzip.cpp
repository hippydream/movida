...
public:
    ...
    QMap<QString, MvdZipEntry *> *headers;
    ...
    MvdUnZip::ErrorCode extractFile(const QString &path, MvdZipEntry &entry,
    const QDir &dir, MvdUnZip::ExtractionOptions options);
    MvdUnZip::ErrorCode extractFile(const QString &path, MvdZipEntry &entry,
    QIODevice *device, MvdUnZip::ExtractionOptions options);

    MvdUnZip::ErrorCode testPassword(quint32 *keys, const QString &file, const MvdZipEntry &header);
    bool testKeys(const MvdZipEntry &header, quint32 *keys);
...
MvdUnZip::ErrorCode MvdUnZip::Private::openArchive(QIODevice *dev)
{
    Q_ASSERT(dev != 0);
 ...
 */
MvdUnZip::ErrorCode MvdUnZip::Private::parseLocalHeaderRecord(const QString &path, MvdZipEntry &entry)
{
...
*/
MvdUnZip::ErrorCode MvdUnZip::Private::seekToCentralDirectory()
{
...
*/
MvdUnZip::ErrorCode MvdUnZip::Private::parseCentralDirectoryRecord()
{
    // Read CD record
    ...
    if (headers == 0)
        headers = new QMap<QString, MvdZipEntry *>();
...
void MvdUnZip::Private::closeArchive()
{
    if (device == 0)
        return;
...
//! \internal
MvdUnZip::ErrorCode MvdUnZip::Private::extractFile(const QString &path, MvdZipEntry &entry, const QDir &dir, MvdUnZip::ExtractionOptions options)
{
    QString name(path);
    QString dirname;
    QString directory;
...
//! \internal
MvdUnZip::ErrorCode MvdUnZip::Private::extractFile(const QString &path, MvdZipEntry &entry, QIODevice *dev, MvdUnZip::ExtractionOptions options)
{
    Q_UNUSED(options);
    Q_ASSERT(dev != 0);
...
bool MvdUnZip::Private::createDirectory(const QString &path)
{
    QDir d(path);
...
*/
quint32 MvdUnZip::Private::getULong(const unsigned char *data, quint32 offset) const
{
...
*/
quint64 MvdUnZip::Private::getULLong(const unsigned char *data, quint32 offset) const
{
...
*/
quint16 MvdUnZip::Private::getUShort(const unsigned char *data, quint32 offset) const
{
...
*/
int MvdUnZip::Private::decryptByte(quint32 key2) const
{
...
*/
void MvdUnZip::Private::updateKeys(quint32 *keys, int c) const
{
...
/*!
    ...
    the given password.
*/
void MvdUnZip::Private::initKeys(const QString &pwd, quint32 *keys) const
{
    keys[0] = 305419896L;
    keys[1] = 591751049L;
    keys[2] = 878082192L;
...
*/
MvdUnZip::ErrorCode MvdUnZip::Private::testPassword(quint32 *keys, const QString &file, const MvdZipEntry &header)
{
    Q_UNUSED(file);
    ...
    while (true) {
        ...
        switch (res) {
            case MvdUnZip::NoError:
                break;

            case MvdUnZip::EncryptedFileSkipped:
                return MvdUnZip::EncryptedFileSkipped;

            default:
                return MvdUnZip::AllEncryptedFilesSkipped;
        }
...
*/
bool MvdUnZip::Private::testKeys(const MvdZipEntry &header, quint32 *keys)
{
    char lastByte;
...
*/
void MvdUnZip::Private::decryptBytes(quint32 *keys, char *buffer, qint64 read)
{
...
*/
QDateTime MvdUnZip::Private::convertDateTime(const unsigned char date[2], const unsigned char time[2]) const
{
    QDateTime dt;
...
void MvdUnZip::Private::emitProgress()
{
...
QString MvdUnZip::formatError(MvdUnZip::ErrorCode c) const
{
    switch (c) {
        case NoError:
            return QCoreApplication::translate("MvdUnZip", "ZIP operation completed successfully."); break;

        case ZlibInitError:
            return QCoreApplication::translate("MvdUnZip", "Failed to initialize or load zlib library."); break;

        case ZlibError:
            return QCoreApplication::translate("MvdUnZip", "zlib library error."); break;

        case FileOpenError:
            return QCoreApplication::translate("MvdUnZip", "Unable to create or open file."); break;

        case FilePartiallyCorruptedError:
            return QCoreApplication::translate("MvdUnZip", "Partially corrupted archive. Some files might be extracted."); break;

        case FileCorruptedError:
            return QCoreApplication::translate("MvdUnZip", "FileCorruptedError archive."); break;

        case WrongPasswordError:
            return QCoreApplication::translate("MvdUnZip", "Wrong password."); break;

        case NoOpenArchiveError:
            return QCoreApplication::translate("MvdUnZip", "No archive has been created yet."); break;

        case FileNotFoundError:
            return QCoreApplication::translate("MvdUnZip", "File or directory does not exist."); break;

        case ReadError:
            return QCoreApplication::translate("MvdUnZip", "File read error."); break;

        case WriteError:
            return QCoreApplication::translate("MvdUnZip", "File write error."); break;

        case SeekError:
            return QCoreApplication::translate("MvdUnZip", "File seek error."); break;

        case CreateDirError:
            return QCoreApplication::translate("MvdUnZip", "Unable to create a directory."); break;

        case InvalidDeviceError:
            return QCoreApplication::translate("MvdUnZip", "Invalid device."); break;

        case InvalidArchiveError:
            return QCoreApplication::translate("MvdUnZip", "Invalid or incompatible zip archive."); break;

        case HeaderConsistencyError:
            return QCoreApplication::translate("MvdUnZip", "Inconsistent headers. Archive might be corrupted."); break;
...
QList<MvdUnZip::ZipEntry> MvdUnZip::entryList() const
{
    ...
    if (d->headers != 0) {
        for (QMap<QString, MvdZipEntry *>::ConstIterator it = d->headers->constBegin(); it != d->headers->constEnd(); ++it) {
            const MvdZipEntry *entry = it.value();
            Q_ASSERT(entry != 0);
...
MvdUnZip::ErrorCode MvdUnZip::extractAll(const QDir &dir, ExtractionOptions options)
{
    ...
    if (d->progressCallbackObject) {
        for (QMap<QString, MvdZipEntry *>::Iterator itr = d->headers->begin(); itr != d->headers->end(); ++itr) {
            MvdZipEntry *entry = itr.value();
            Q_ASSERT(entry != 0);
...
MvdUnZip::ErrorCode MvdUnZip::extractFile(const QString &filename, const QDir &dir, ExtractionOptions options)
{
    ...
    QMap<QString, MvdZipEntry *>::Iterator itr = d->headers->find(filename);
    if (itr != d->headers->end()) {
        MvdZipEntry *entry = itr.value();
        Q_ASSERT(entry != 0);
        d->totalProgress = entry->szUncomp;
