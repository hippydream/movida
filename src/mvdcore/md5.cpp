...
void updateHash(Md5Context *context, const char *data, qint64 length);
void md5Transform(quint32 buf[4], quint32 const in[16]);
QString finalize(Md5Context &ctx);
}
...
//! \internal
void updateHash(Md5Context *ctx, const char *data, qint64 length)
{
    quint32 t;
